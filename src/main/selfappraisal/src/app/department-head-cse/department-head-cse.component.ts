...
@Component({
  selector: 'app-department-head-cse',
  templateUrl: './department-head-cse.component.html',
  styleUrls: ['./department-head-cse.component.css']
})
export class DepartmentHeadCseComponent implements OnInit {
