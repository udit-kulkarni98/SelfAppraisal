...
@Component({
  selector: 'app-department-head-it',
  templateUrl: './department-head-it.component.html',
  styleUrls: ['./department-head-it.component.css']
})
export class DepartmentHeadItComponent implements OnInit {
