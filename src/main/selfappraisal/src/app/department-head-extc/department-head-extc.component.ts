...
@Component({
  selector: 'app-department-head-extc',
  templateUrl: './department-head-extc.component.html',
  styleUrls: ['./department-head-extc.component.css']
})
export class DepartmentHeadExtcComponent implements OnInit {
