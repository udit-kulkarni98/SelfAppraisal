...
@Component({
  selector: 'app-department-head-ce',
  templateUrl: './department-head-ce.component.html',
  styleUrls: ['./department-head-ce.component.css']
})
export class DepartmentHeadCeComponent implements OnInit {
