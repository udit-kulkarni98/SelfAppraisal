...
@Component({
  selector: 'app-department-head-ee',
  templateUrl: './department-head-ee.component.html',
  styleUrls: ['./department-head-ee.component.css']
})
export class DepartmentHeadEeComponent implements OnInit {
