...
@Component({
  selector: 'app-assistant-professors',
  templateUrl: './assistant-professors.component.html',
  styleUrls: ['./assistant-professors.component.css']
})
export class AssistantProfessorsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.data.designation="Assistant Professor";
  }
